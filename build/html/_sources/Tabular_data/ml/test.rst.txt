...
.. function:: test(n_clusters=2, scaled_df=None, df=None, eps_dbscan=0.5, min_samples_dbscan=4, metric_dbscan='euclidean', affinity_agglomerative='euclidean')
    ...
    **Parameters**:
    ...
    - **df** (*DataFrame, optional*): The original dataset, preserving its intrinsic attributes and facilitating comprehensive analysis and visualization.
    ...
    - **affinity_agglomerative** (*str, optional*): The affinity type to use in Agglomerative Clustering. Default is 'euclidean'.

    **Returns**:

    A dataframe enriched with cluster labels derived from each of the tested clustering algorithms and a multi-plot visualization showcasing clustering outcomes, fostering intuitive interpretation and comparative assessment.
