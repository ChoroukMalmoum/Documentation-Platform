...
------------------------
The model exportation feature allows users to save the trained image classification model for later use. This is particularly useful when you want to reuse the model without retraining it. The exportation is performed using the Joblib library.
